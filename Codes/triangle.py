...
sock1.sendto('forward 74'.encode(), 0, ('192.168.10.1', 8889))
sock2.sendto('cw 0'.encode(), 0, ('192.168.10.1', 8889))
sock3.sendto('right 200'.encode(), 0, ('192.168.10.1', 8889))
...
sock2.sendto('cw 0'.encode(), 0, ('192.168.10.1', 8889))
sock3.sendto('forward 100'.encode(), 0, ('192.168.10.1', 8889))
...
sock1.sendto('cw 150'.encode(), 0, ('192.168.10.1', 8889))
sock2.sendto('cw 30'.encode(), 0, ('192.168.10.1', 8889))
sock3.sendto('ccw 90'.encode(), 0, ('192.168.10.1', 8889))
...
sock1.sendto('forward 200'.encode(), 0, ('192.168.10.1', 8889))
sock2.sendto('forward 200'.encode(), 0, ('192.168.10.1', 8889))
sock3.sendto('forward 200'.encode(), 0, ('192.168.10.1', 8889))
...
sock1.sendto('ccw 150'.encode(), 0, ('192.168.10.1', 8889))
sock2.sendto('ccw 30'.encode(), 0, ('192.168.10.1', 8889))
sock3.sendto('cw 90'.encode(), 0, ('192.168.10.1', 8889))
...
sock1.sendto('back 100'.encode(), 0, ('192.168.10.1', 8889))
sock2.sendto('back 74'.encode(), 0, ('192.168.10.1', 8889))
...
sock1.sendto('left 200'.encode(), 0, ('192.168.10.1', 8889))
sock2.sendto('left 100'.encode(), 0, ('192.168.10.1', 8889))
sock3.sendto('forward 25'.encode(), 0, ('192.168.10.1', 8889))
